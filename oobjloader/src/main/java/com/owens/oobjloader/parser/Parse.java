...
public class Parse {
    ...
    public Parse(BuilderInterface builder, InputStream inputStream, String name) throws FileNotFoundException, IOException {
        this.builder = builder;
        builder.setObjFilename(name);
        parseObjInputSrtream(inputStream);
        builder.doneParsingObj(name);
    }

    private void parseObjInputSrtream(InputStream inputStream) throws IOException {
        int lineCount = 0;
    ...
    private void parseObjFile(String objFilename) throws FileNotFoundException, IOException {
        ...
        parseObjInputSrtream(new FileInputStream(objFile));
    }
